                    ...
                    <div class="row g-0 ">
                        ...
                        <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                            <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                <section class='brand'>
                                    <div class='brandText' style="text-align: center">
                                        <h3 class="mb-4">منصة الإطعام الجامعي</h3><br/>

                                        <h6 style="font-size: 12px"> وزارة التــعليـــم العالـــي و الـــبحث العلمـــي  ©  جميع الحقوق محفوظة  2024</h6>
                                        <h6 style="font-size: 12px">إصدار 1.0.0 </h6>
                                    </div>
                            </div>
                        </div>
                    </div>
